					...
					comparers = {
						...
						d: function ( dateA, dateB  ) {
							var setHours = _setHours,
								offset = _getOffset,
								offsetA = offset.call( dateA ),
								offsetB = offset.call( dateB ),
								compensation = ( offsetB - offsetA ) * 60000;
							// ~~ faster than Math.floor
							return ~~(( setHours.call( new Date( dateB ), 0 ) - setHours.call( new Date( dateA ), 0 ) + compensation ) / 86399948.58 );
							},
